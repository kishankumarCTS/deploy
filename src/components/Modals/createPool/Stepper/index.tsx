...
import PoolStep1 from "../Step1";
import PoolStep2 from "../Step2";
import PoolStep3 from "../Step3";

const STEPS = [
  { id: 1, title: "Pool & Health Monitor" },
  { id: 2, title: "Add Backend Server" },
  { id: 3, title: "Review & Create" },
];

interface PoolStepperProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess?: () => void;
}

function PoolStepper({ isOpen, onClose, onSuccess }: PoolStepperProps) {
